...
class SSNetFinal(nn.Module):
    def __init__(self, num_classes=2, seg_num = 32):
        super(SSNetFinal, self).__init__()
    ...
    def forward(self, x):
        ...
        fs4 = self.refine9(F.upsample_bilinear(fs3, pool_x.size()[2:]))
